...
def model(upae=False):
    ...
    if upae is True:
        ...
        z_mean = layers.Dense(latentSize, name="z_mean")(latent_enc)
        z_log_var = layers.Dense(latentSize, name="z_log_var")(latent_enc)
    ...
    decoder = keras.Model(latent_enc, outputs, name="decoder")
...
if __name__ == "__main__":
    ...
    # vae.fit(image_datasets[0], epochs=30, batch_size=128)
